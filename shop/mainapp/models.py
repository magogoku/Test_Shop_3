...
class Notebook(Product):
    ...
    time_without_charge = models.CharField(max_length=200, verbose_name='Время работа аккумулятора')
...
class Smartphone(Product):
    ...
    accum_volume = models.CharField(max_length=200, verbose_name="Объем батареи")
    ram = models.CharField(max_length=200, verbose_name='Оперативная память')
    sd = models.BooleanField(default=True, verbose_name='Наличие SD карты')
    sd_volume_max = models.CharField(max_length=200, null=True, blank=True, verbose_name='Максимальный объем встраиваемой памяти')
    main_cam_mp = models.CharField(max_length=200, verbose_name="Главная камера")
    frontal_cam_mp = models.CharField(max_length=200, verbose_name="Фронтальная камера")
